...
CREATE TABLE IF NOT EXISTS feedback.survey_questions
(
    id        INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    question_text TEXT,
    questionType TEXT
...
CREATE TABLE IF NOT EXISTS feedback.survey_answers
(
    id        INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id   INT REFERENCES auth.person (id),
    question_id INT REFERENCES feedback.survey_questions (id),
    grade INT,
